<div class="colunaNoticias" id="newsContainer">
    <?php 
    // Busca o post mais recente da categoria "Umarizal"
    $query = new WP_Query(array(
        'posts_per_page' => 1,
        'category_name' => 'Umarizal', // Filtra por categoria "Umarizal"
    ));
    ...
    <ul class="outrasNoticias">
        <?php 
        // Busca os 6 posts mais recentes da categoria "Umarizal" (excluindo o primeiro, se já mostrado antes)
        $query = new WP_Query(array(
            'posts_per_page' => 6,
            'offset' => 1,
            'category_name' => 'Umarizal', // Filtra por categoria "Umarizal"
