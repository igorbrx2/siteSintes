<div class="colunaNoticias" id="newsContainer">
    <?php 
    // Busca o post mais recente da categoria "São Gonçalo"
    $query = new WP_Query(array(
        'posts_per_page' => 1,
        'category_name' => 'São Gonçalo', // Filtra por categoria "São Gonçalo"
    ));
    ...
    <ul class="outrasNoticias">
        <?php 
        // Busca os 6 posts mais recentes da categoria "São Gonçalo" (excluindo o primeiro, se já mostrado antes)
        $query = new WP_Query(array(
            'posts_per_page' => 6,
            'offset' => 1,
            'category_name' => 'São Gonçalo', // Filtra por categoria "São Gonçalo"
