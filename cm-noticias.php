<div class="colunaNoticias" id="newsContainer">
    <?php 
    // Busca o post mais recente da categoria "Ceará-Mirim"
    $query = new WP_Query(array(
        'posts_per_page' => 1,
        'category_name' => 'Ceará-Mirim', // Filtra por categoria "Ceará-Mirim"
    ));
    ...
    <ul class="outrasNoticias">
        <?php 
        // Busca os 6 posts mais recentes da categoria "Ceará-Mirim" (excluindo o primeiro, se já mostrado antes)
        $query = new WP_Query(array(
            'posts_per_page' => 6,
            'offset' => 1,
            'category_name' => 'Ceará-Mirim', // Filtra por categoria "Ceará-Mirim"
